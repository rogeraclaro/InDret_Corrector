...
<!--<?php if (get_query_var('edicion')) $edicio = $edicion; ?>-->
<!--<?php print "edicio = $edicio"; ?>-->
		...
		<ul class="bxslider_2">
			<?php 
				...
				<?php if( $the_query->have_posts() ): ?>
					...
					<?php endwhile; ?>
				<?php else : ?>
					<li><div class="banner_caixa1">No n'hi ha</div></li>
				<?php endif; ?>
			<?php wp_reset_query();	 // Restore global post data stomped by the_post(). ?>
		</ul>
	</div>
...
<div class="container">
	<div class="menu-segon">
		...
		<div class="col-md-3 actualida"><a href="<?php echo esc_url( home_url( '/' ) ); ?>actualidad/">Actualidad</a></div>
		<div class="col-md-3 sumario"><a href="<?php echo esc_url( home_url( '/' ) ); ?>sumario/">Sumario</a></div>
		<div class="col-md-3 ed-anteriores"><a href="<?php echo esc_url( home_url( '/' ) ); ?>anteriores/">Ediciones anteriores</a></div>
	</div>
</div>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6'); ?>>
							<div class="entry-header altura_entrada_home">
								...
								<div class="categoria">
									...
									?>
									<a href="<?php echo $nomcategoria; ?>"><?php the_field('nombre_area'); ?></a>
								</div>								
