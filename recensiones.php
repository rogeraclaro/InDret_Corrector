...
/**
 * Template Name: Recensiones principal
 * @package InDret
 */
...
<?php if ($the_query->have_posts()) { ?>
		...
		if ($language == "es") { ?>
			<div class="menu-segon">
				<div class="row">
					...
					<div class="col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Ediciones
							anteriores</a></div>
				</div>
			</div>
		<? } else if ($language == "ca") { ?>
			<div class="menu-segon">
				<div class="row">
					...
					<div class="col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Edicions
							anteriors</a></div>
				</div>
			</div>
		<? } else if ($language == "en") { ?>
			<div class="menu-segon">
				<div class="row">
					...
					<div class="col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Past
							Issues</a></div>
				</div>
			</div>
		<? }
	...
	<script>
		jQuery('.recensions a').addClass('actual');
	</script>
	...
	<div class="container-fluid barra-inferior">
		<div class="container">
			<div class="col-sm-12 col-md-12"><a href="<?php echo esc_url(home_url('/')); ?>los-mas-leidos"><span class="boto-peu autor"><?php if ($language == "en") {
