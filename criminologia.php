...
<?php if($language=="en") { ?>
<script>
  jQuery(".titol-branca").html('Criminology');
</script>
<?php } else if($language=="es") { ?>
<script>
  jQuery(".titol-branca").html('Criminolog&iacute;a');
</script>
<?php } else if($language=="ca") { ?>
<script>
  jQuery(".titol-branca").html('Criminologia');
</script>
<?php } ?>
					...
					<div class="entry-header altura_entrada_home">
						...
						<div class="categoria">
							...
							<a href="<?php echo $nomcategoria . '/?edicion=' . $edicio; ?>">
									<?php if($language=="en") { echo 'Criminology'; } else if($language=="es") {echo 'Criminolog&iacute;a';} else if($language=="ca") {echo 'Criminologia';} ?>
							</a>
						</div>
