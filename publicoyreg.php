<?php
/**
 * Template Name: Público y regulatorio
 * @package InDret
 **/
...
<?php if($language=="en") { ?>
<script>
  jQuery(".titol-branca").html('Administrative law');
</script>
<?php } else if($language=="es") { ?>
<script>
  jQuery(".titol-branca").html('P&uacute;blico y regulatorio');
</script>
<?php } else if($language=="ca") { ?>
<script>
  jQuery(".titol-branca").html('P&uacute;blic i regulatori');
</script>
<?php } ?>
