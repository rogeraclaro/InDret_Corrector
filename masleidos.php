...
<div class="container-fluid editorial">
	<div class="container">
		<div class="banner invers">
			<?php global $language;
			if ($language == "es") { ?>
				<h1 class="entry-title-interior">Los más leídos</h1>
			<?php } else if ($language == "ca") { ?>
				<h1 class="entry-title-interior">Els més llegits</h1>
			<?php } else if ($language == "en") { ?>
				<h1 class="entry-title-interior">Most widely read</h1>
			<?php } ?>
		</div>
	</div>
</div>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main col-md-12" role="main">
			...
			$the_query = new WP_Query(array(
				'post_type'	=> 'post',
				'orderby' => 'ranking_clause',
				'paged' => get_query_var('paged'),
				'meta_query' => array(
					'relation' => 'AND',
					'ranking_clause' => array(
						'key' => 'ranking_descargas',
						...
						<div class="entry-header altura_entrada_home">
							...
							<div class="peu_entrada_home">
								...
								<div class="autor">
									...
									if ($terms) : ?><span class="pertallarcoma"><?php foreach ($terms as $term) : ?><a href="<?php echo get_term_link($term); ?>"><?php echo $term->name; ?><span class="separa-coma">,</span>
												</a><?php endforeach; ?></span><?php endif; ?>
								</div>
			...
			<div class="row estret">
				...
				<div class="col-md-10 paginador"><?php wp_pagenavi(array('query' => $the_query)); ?></div>
			</div>
