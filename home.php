...
<?php if ($the_query->have_posts()) { ?>
	...
	<div class="container">
		...
		if ($language == "es") { ?>
			<div class="menu-segon">
				<div class="row">
					<div class="col-xs-2 col-md-2 col-xs-offset-1 col-md-offset-1 sumario"><a href="<?php echo esc_url(home_url('/')); ?>sumarios/sumario<?php echo '-' . $edicio[0];
																																							$resultat = substr($edicio, 2, 3);
																																							echo '-' . $resultat; ?>?edicion=<?php echo $edicio; ?>">Índice</a>
					</div>
					<div class="col-xs-2 col-md-2 ed-actual"><a href="<?php echo esc_url(home_url('/')); ?>?edicion=<?php echo $edicio; ?>" class="actual">Análisis</a></div>
					<div class="col-xs-2 col-md-2 actualida"><a href="<?php echo esc_url(home_url('/')); ?>actualidad/?edicion=<?php echo $edicio; ?>">Actualidad</a>
					</div>
					<div class="col-xs-2 col-md-2 recensions"><a href="<?php echo esc_url(home_url('/')); ?>recensiones/?edicion=<?php echo $edicio; ?>">Recensiones y traducciones</a>
					</div>
					<div class="col-xs-2 col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Ediciones
							anteriores</a></div>
				</div>
			</div>
		<? } else if ($language == "ca") { ?>
			<div class="menu-segon">
				<div class="row">
					<div class="col-xs-4 col-md-2 col-xs-offset-1 col-md-offset-1 sumario"><a href="<?php echo esc_url(home_url('/')); ?>sumarios/sumario<?php echo '-' . $edicio[0];
																																							$resultat = substr($edicio, 2, 3);
																																							echo '-' . $resultat; ?>?edicion=<?php echo $edicio; ?>">Índex</a>
					</div>
					<div class="col-xs-4 col-md-2 ed-actual"><a href="<?php echo esc_url(home_url('/')); ?>?edicion=<?php echo $edicio; ?>" class="actual">Anàlisi</a></div>
					<div class="col-xs-4 col-md-2 actualida"><a href="<?php echo esc_url(home_url('/')); ?>actualidad/?edicion=<?php echo $edicio; ?>">Actualitat</a>
					</div>
					<div class="col-xs-6 col-md-2 recensions"><a href="<?php echo esc_url(home_url('/')); ?>recensiones/?edicion=<?php echo $edicio; ?>">Recensions i traduccions</a>
					</div>
					<div class="col-xs-6 col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Edicions
							anteriors</a></div>
				</div>
			</div>
		<? } else if ($language == "en") { ?>
			<div class="menu-segon">
				<div class="row">
					<div class="col-xs-2 col-md-2 col-xs-offset-1 col-md-offset-1 sumario"><a href="<?php echo esc_url(home_url('/')); ?>sumarios/sumario<?php echo '-' . $edicio[0];
							...
							of contents</a></div>
					<div class="col-xs-2 col-md-2 ed-actual"><a href="<?php echo esc_url(home_url('/')); ?>?edicion=<?php echo $edicio; ?>" class="actual">Articles</a></div>
					<div class="col-xs-2 col-md-2 actualida"><a href="<?php echo esc_url(home_url('/')); ?>actualidad/?edicion=<?php echo $edicio; ?>">Notes</a></div>
					<div class="col-xs-2 col-md-2 recensions"><a href="<?php echo esc_url(home_url('/')); ?>recensiones/?edicion=<?php echo $edicio; ?>">Book
							reviews & translations</a>
					</div>
					<div class="col-xs-2 col-md-2 ed-anteriores"><a href="<?php echo esc_url(home_url('/')); ?>anteriores/?edicion=<?php echo $edicio; ?>">Past
							Issues</a></div>
				</div>
			</div>
		<? }
	...
	<div class="container-fluid barra-inferior">
		<div class="container">
			<div class="col-sm-12 col-md-12 "><a href="<?php echo esc_url(home_url('/')); ?>los-mas-leidos" class="leidos"><span class="boto-peu autor"><?php if ($language == "en") {
																																							echo 'Most downloaded articles';
																																						} else if ($language == "es") {
																																							echo 'Los más leídos';
																																						} else if ($language == "ca") {
			...
			<!--<div class="col-sm-6 col-md-6"><a href="#"><span
					class="boto-peu autor"><?php if ($language == "en") {
												echo 'Subscribe';
											} else if ($language == "es") {
												echo 'Suscripción';
											} else if ($language == "ca") {
