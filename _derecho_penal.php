		...
		<div class="row" style="padding-top: 30px; margin-bottom:-30px">
			...
			<div class="col-md-10">
				<div class="coordinadors">
					...
					<?php echo '<strong>Secretaria/o de redacci&oacute;n: </strong> ' . get_field('coordinadors_sec'); ?><br>
					<?php } ?>
					...
					<?php } if (get_field('coordinadors_sec')) { ?>
					<?php echo '<strong>Secretaria/o de redacci&oacute;: </strong> ' . get_field('coordinadors_sec'); ?><br>
					<?php } ?>
		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main col-md-12" role="main">
					...
					<div class="entry-header altura_entrada_home">
						...
						<div class="categoria">
							<?php
									...
									$nomcategoria = str_replace('Ì', 'i', $nomcategoria);
									...
									if($language=="en") {
										...
										else if ($nomcategoria=='Criminologia') {$nomarea = 'CriminologÌa';}
						...
						<div class="peu_entrada_home">
							...
							<div class="xarxes_soc"><span class="descargas <?php echo get_the_ID(); ?>">
								...
								<?php
									...
									else if($language=="ca") {echo 'desc√†rregues';} ?>
							</div>
				...
				<div style="display:none" class="fancybox-hidden">
					<div id="contact-form">
						<span class="autor-interior">Enviar art√≠culo</span>
