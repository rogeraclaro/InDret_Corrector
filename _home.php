				...
				<li>
					<div class="banner_caixa1">
						...
						<div class="banner-titular">
							<?php the_title( sprintf( '<a href="%s?edicion=%s" rel="bookmark">', esc_url( get_permalink() ), $edicio ), '</a>' ); ?>
						</div>
...
<div class="container">
	...
	<div class="menu-segon">
		<div class="row">
			<div class="col-xs-2 col-md-2 col-md-offset-1 sumario"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>sumarios/sumario<?php echo '-' . $edicio[0]; $resultat = substr($edicio, 2, 3); echo '-' . $resultat; ?>?edicion=<?php echo $edicio; ?>">Índice</a>
			</div>
			<div class="col-xs-2 col-md-2 ed-actual"><a href="<?php echo esc_url( home_url( '/' ) ); ?>?edicion=<?php echo $edicio; ?>"
					class="actual">Análisis</a></div>
			<div class="col-xs-2 col-md-2 actualida"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>actualidad/?edicion=<?php echo $edicio; ?>">Actualidad</a>
			</div>
			<div class="col-xs-2 col-md-2 recensions"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>recensiones/?edicion=<?php echo $edicio; ?>">Recensiones</a>
			</div>
			<div class="col-xs-2 col-md-2 ed-anteriores"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>anteriores/?edicion=<?php echo $edicio; ?>">Ediciones
					anteriores</a></div>
		</div>
	</div>
	<?}
	...
	<div class="menu-segon">
		<div class="row">
			<div class="col-xs-4 col-md-2 col-md-offset-1 sumario"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>sumarios/sumario<?php echo '-' . $edicio[0]; $resultat = substr($edicio, 2, 3); echo '-' . $resultat; ?>?edicion=<?php echo $edicio; ?>">Índex</a>
			</div>
			<div class="col-xs-4 col-md-2 ed-actual"><a href="<?php echo esc_url( home_url( '/' ) ); ?>?edicion=<?php echo $edicio; ?>"
					class="actual">Anàlisi</a></div>
			<div class="col-xs-4 col-md-2 actualida"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>actualidad/?edicion=<?php echo $edicio; ?>">Actualitat</a>
			</div>
			<div class="col-xs-6 col-md-2 recensions"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>recensiones/?edicion=<?php echo $edicio; ?>">Recensions</a>
			</div>
			<div class="col-xs-6 col-md-2 ed-anteriores"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>anteriores/?edicion=<?php echo $edicio; ?>">Edicions
					anteriors</a></div>
		</div>
	</div>
	<?}
	...
	<div class="menu-segon">
		<div class="row">
			<div class="col-xs-2 col-md-2 col-md-offset-1 sumario"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>sumarios/sumario<?php echo '-' . $edicio[0]; $resultat = substr($edicio, 2, 3); echo '-' . $resultat; ?>?edicion=<?php echo $edicio; ?>">Table
					of contents</a></div>
			<div class="col-xs-2 col-md-2 ed-actual"><a href="<?php echo esc_url( home_url( '/' ) ); ?>?edicion=<?php echo $edicio; ?>"
					class="actual">Articles</a></div>
			<div class="col-xs-2 col-md-2 actualida"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>actualidad/?edicion=<?php echo $edicio; ?>">Notes</a></div>
			<div class="col-xs-2 col-md-2 recensions"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>recensiones/?edicion=<?php echo $edicio; ?>">Book
					reviews</a>
			</div>
			<div class="col-xs-2 col-md-2 ed-anteriores"><a
					href="<?php echo esc_url( home_url( '/' ) ); ?>anteriores/?edicion=<?php echo $edicio; ?>">Past
					Issues</a></div>
		</div>
	</div>
	<?}
		...
		<main id="main" class="site-main col-md-12" role="main">
			...
			$the_query = new WP_Query(array(
				...
				'meta_query'	=> array(
					...
					array(
						'key'     => 'nombre_subarea',
						'value'   => 'Working papers, Doctrina',
						),
					array(
						'key'	  => 'nombre_subarea',
						'value'	  => 'Comentaris de Jurisprudència, Notes on case law, Comentarios de Jurisprudencia',
						),
					/* array(
				    	'key'      => 'idioma',
				    	'value'    => 'es'
				...
				<div class="entry-header altura_entrada_home">
					...
					<div class="categoria">
						...
						<a href="<?php echo $nomcategoria . '/?edicion=' . $edicio; ?>">
							<? echo $nomarea; ?>
							<!--<br><?php the_field('nombre_area'); ?>--></a>
					</div>
			...
			$the_query = new WP_Query(array(
				...
				'tax_query' => array(
					...
					array(
						'taxonomy' => 'category',
						'field'    => 'slug',
						'terms'    => array('Portada','Destacado','Editorial'),
						'operator' => 'NOT IN'
						),
					array(
						'taxonomy' => 'category',
...
<div class="container-fluid barra-inferior">
	<div class="container">
		<div class="col-sm-6 col-md-6"><a href="<?php echo esc_url( home_url( '/' ) ); ?>los-mas-leidos"><span
					class="boto-peu autor"><?php if($language=="en") {echo 'Most downloaded articles';} else if($language=="es") {echo 'Los más leídos';	} else if($language=="ca") {echo 'Els més llegits';} ?></span></a>
		</div>
		<div class="col-sm-6 col-md-6"><a href="#"><span
					class="boto-peu autor"><?php if($language=="en") {echo 'Subscribe';} else if($language=="es") {echo 'Suscripción';	} else if($language=="ca") {echo 'Subscripció';} ?></span></a>
		</div>
	</div>
</div>
