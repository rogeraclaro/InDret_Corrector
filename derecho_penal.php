...
<?php if($language=="en") { ?>
<script>
  jQuery(".titol-branca").html('Criminal law');
</script>
<?php } else if($language=="es") { ?>
<script>
  jQuery(".titol-branca").html('Penal');
</script>
		...
		<div class="row" style="padding-top: 30px; margin-bottom:-30px">
			...
			<div class="col-md-10">
				<div class="coordinadors">
					...
					<?php echo '<strong>Secretar&iacute;a de redacci&oacute;n: </strong> ' . get_field('coordinadors_sec'); ?><br>
					<?php if (get_field('colabper')) { ?>
						<strong><a href="#" class="botocol">Colaboradores permanentes <span class="toggle-icon"></span></a></strong>
						<div class="colabpernoms"><?php echo get_field('colabper'); ?></div>
					<?php } ?>
					<?php } ?>
					<?php } else if($language=="ca") { ?>
					<?php if (get_field('coordinadors_dir')) { ?>
					...
					<?php } if (get_field('coordinadors_sec')) { ?>
                    <?php echo '<strong>Secretariat redacci&oacute;: </strong> ' . get_field('coordinadors_sec'); ?><br>
					<?php if (get_field('colabper')) { ?>
							<strong><a href="#" class="botocol">Col&middot;laboradors permanents <span class="toggle-icon"></span></a></strong>
							<div class="colabpernoms"><?php echo get_field('colabper'); ?></div>
					<?php } ?>
					<?php } ?>
					...
					<?php if (get_field('colabper')) { ?>
							<strong><a href="#" class="botocol">Permanent collaborators <span class="toggle-icon"></span></a></strong>
							<div class="colabpernoms"><?php echo get_field('colabper'); ?></div>
					<?php } ?>
					<?php } ?>
					<?php } ?>
					...
					<div class="entry-header altura_entrada_home">
						...
						<div class="categoria">
							<?php
									...
									$nomcategoria = str_replace('�', 'i', $nomcategoria);
									$nomcategoria = str_replace('�', 'u', $nomcategoria);
									if($language=="en") {
										...
										else if ($nomcategoria=='Criminologia') {$nomarea = 'Criminolog�a';}
										else if ($nomcategoria=='Derechopenal') {$nomarea = 'Penal';}
										else if ($nomcategoria=='Publicoyregulatorio') {$nomarea = 'P�blico y regulatorio';}
									}
									else if($language=="ca") {
										if ($nomcategoria=='Derechoprivado') {$nomarea = 'Privat';}
										else if ($nomcategoria=='Criminologia') {$nomarea = 'Criminologia';}
										else if ($nomcategoria=='Derechopenal') {$nomarea = 'Penal';}
										else if ($nomcategoria=='Publicoyregulatorio') {$nomarea = 'P�blic i regulatori';}
									}
									?>
